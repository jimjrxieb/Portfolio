...
from app.schemas.avatar import TTSRequest, TTSResponse, TalkRequest, TalkResponse
from app.services.elevenlabs import synthesize_tts_mp3
from app.services.did import create_talk_with_audio, get_talk_status
...
async def create_avatar_mcp(req: MCPAvatarRequest):
    ...
    try:
        result = await mcp_client.create_avatar_with_text(
            text=req.text, image_url=req.image_url, voice_style=req.voice_style
        )
