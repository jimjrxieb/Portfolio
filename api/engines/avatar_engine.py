...
class AvatarEngine:
    ...
    def generate_video(self, script: str, image_path: Optional[str] = None) -> str:
        ...
        logger.info(f"Avatar engine: {self.engine}, generating video for script: {script[:50]}...")
    ...
    def get_status(self) -> dict:
        ...
        return {
            "engine": self.engine,
            "status": "ready",
            "features": ["text_to_avatar"] if self.engine == "local" else ["text_to_avatar", "voice_cloning"]
        }
