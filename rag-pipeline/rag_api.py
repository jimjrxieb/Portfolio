...
async def query_knowledge(request: QueryRequest):
    ...
    try:
        ...
        base_response = context_responses.get(request.context_type, context_responses["general"])
        ...
        response = openai.chat.completions.create(
            model=GPT_MODEL,
            messages=[
                {"role": "system", "content": "You are providing detailed information about Jimmie Coleman's technical expertise and projects."},
