        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-jade-500/10 to-crystal-500/10 backdrop-blur-sm rounded-2xl border border-jade-500/30 p-8">
            ...
            <h2 className="text-2xl font-bold text-white mb-6 text-center">
              Understand <span className="text-text-muted mx-1">&gt;</span>{' '}
              Secure <span className="text-text-muted mx-1">&gt;</span> Verify{' '}
            ...
            <p className="text-text-secondary text-sm leading-relaxed mb-4">
              ...
              . Everything I&apos;ve built over the past two years has been
            ...
            <p className="text-text-secondary text-sm leading-relaxed mb-4">
              I configure open-source tools not to replace enterprise solutions,
              but to{' '}
              <span className="text-white font-medium">
                automate them and filter noise
              </span>
              . Trivy, Semgrep, Falco, OPA — each one is tuned to surface what
              matters and suppress what doesn&apos;t, so analysts spend time on
              real findings instead of duplicates. The point isn&apos;t the tool
              itself. Understanding{' '}
              <span className="text-crystal-400 font-medium">
                what the tool is supposed to prevent or provide
              </span>{' '}
              is what matters most. Without that understanding, you&apos;re just
              generating alerts nobody reads.
            </p>

            {/* Paragraph 3 — Portfolio + tooling */}
            <p className="text-text-secondary text-sm leading-relaxed mb-4">
              This portfolio site is a production app built with security and
              GitOps best practices end to end. Code pushes trigger an{' '}
              <span className="text-crystal-400 font-medium">
                8-scanner CI pipeline
              </span>{' '}
              in GitHub Actions, images deploy to a{' '}
              <span className="text-crystal-400 font-medium">k3s cluster</span>{' '}
              via Helm and ArgoCD, traffic routes through a{' '}
              <span className="text-crystal-400 font-medium">
                Cloudflare Tunnel
              </span>
              , and admission control is enforced by OPA/Gatekeeper — all
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-jade-500/10">
                  <span className="text-jade-400 font-mono font-bold shrink-0">
                    SC-7, SC-8
                  </span>
                  <span className="text-text-secondary">
                    Cloudflare Tunnel — Boundary Protection, Transmission
                    Confidentiality
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-jade-500/10">
                  ...
                  <span className="text-text-secondary">
                    GitHub Actions — Vulnerability Scanning, Developer Testing
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-jade-500/10">
                  <span className="text-jade-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    k3s Cluster — Access Control, Audit Events
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-jade-500/10">
                  <span className="text-jade-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    Helm — Baseline Configuration, Config Settings
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-jade-500/10">
                  <span className="text-jade-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    ArgoCD — Baseline Tracking, Developer Config Management
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-jade-500/10">
                  <span className="text-jade-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    Ansible — Baseline Configuration, Config Deployment
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-jade-500/10">
                  <span className="text-jade-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    OPA/Gatekeeper — Config Policy, Least Functionality, Least
                    Privilege
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-jade-500/10">
                  ...
                  <span className="text-text-secondary">
                    Docker + Trivy — Flaw Remediation, Malware Protection, SBOM
                    Inventory
                  </span>
                </div>
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-crystal-500/10">
                  ...
                  <span className="text-text-secondary">
                    Prompt Injection Detection — Information Input Validation
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-crystal-500/10">
                  <span className="text-crystal-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    Input Sanitization — Input Validation, Mobile Code
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-crystal-500/10">
                  <span className="text-crystal-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    Output Filtering — Information Output Filtering
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-crystal-500/10">
                  <span className="text-crystal-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    Rate Limiting — DoS Protection, Boundary Protection
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-crystal-500/10">
                  <span className="text-crystal-400 font-mono font-bold shrink-0">
                  ...
                  <span className="text-text-secondary">
                    Audit Trail — Audit Events, Content of Records, Record
                    Generation
                  </span>
                </div>
                <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-ink/40 border border-crystal-500/10">
