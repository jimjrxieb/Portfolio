...
const certifications: Certification[] = [
  ...
  { name: 'AWS Solutions Architect Associate', full: 'AWS Certified Solutions Architect – Associate', status: 'in_progress' },
];
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
          <a
            ...
            className="flex items-center gap-2 text-crystal-400 hover:text-crystal-300 transition-colors"
          >
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 mb-6">
          {certifications.map((cert) => (
            <div
              ...
              title={cert.full}
            >
              <span>{cert.status === 'complete' ? '✓' : '○'}</span>
              <span>{cert.name}</span>
            </div>
          ))}
        </div>
        ...
        {/* Quote */}
        <p className="text-text-secondary/70 italic text-sm md:text-base max-w-2xl mx-auto">
