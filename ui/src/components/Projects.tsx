...
const FEATURED_PROJECTS: Record<ProjectKey, Project> = {
  ...
  jade: {
    title: 'Sheyla - AI Engineering Showcase',
    description: 'Production RAG demonstrating AI engineering skills—try it below',
    status: 'Live',
    icon: '🤖',
    ...
    highlights: [
      ...
      'Same architecture scales to GP-Copilot (29,000+ vectors)',
    ],
  },
} as const;
...
const TOOL_CATEGORIES: Record<CategoryKey, ToolCategory> = {
  ...
  aiml: {
    ...
    tools: [
      ...
      { name: 'Claude API Integration', description: 'Production LLM with FastAPI async endpoints', link: 'https://github.com/jimjrxieb/Portfolio/tree/main/api' },
      { name: 'ML Model Training', description: 'Fine-tuning LLMs, policy generation from historical data' },
    ],
  },
  languages: {
